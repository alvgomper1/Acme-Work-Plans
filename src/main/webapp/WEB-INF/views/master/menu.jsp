...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		<acme:menu-option code="master.menu.anonymous" access="isAnonymous()">
			...
			<acme:menu-separator />
			<acme:menu-suboption code="master.menu.anonymous.list-task-not-ended"
				action="/anonymous/task/list" />
			<acme:menu-separator />
			<acme:menu-suboption code="master.menu.anonymous.create-shout"
		...
		<acme:menu-option code="master.menu.authenticated"
			access="hasRole('Authenticated')">
			<acme:menu-suboption code="master.menu.authenticated.list-task-ended"
