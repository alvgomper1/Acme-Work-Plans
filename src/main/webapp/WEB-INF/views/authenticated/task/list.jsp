...
<acme:list>
	...
	<acme:list-column code="authenticated.task.form.label.visibility" path="visibility" width="10%"/>
	<acme:list-column code="authenticated.task.form.label.finished" path="finished" width="10%"/>
